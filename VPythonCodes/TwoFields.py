...
# TwoFields.py:  Motion of charges in 2 frames wi Field TF  
...
beta = 0.4                 # beta = v/c, v of S' wrt S, c=1
...
ux = beta                  # velocity of S' wrt to S
...
def EulerPlusTF():           # Euler ODE solve + Lorentz TF
    ...
    for i in range (0,300):   # loop for  motion
       ...
       rr1 = r2-r1            # relative position q2 wrt r1
       rr2 = -rr1             # relative position q1 wrt r2
       rr = mag(rr1)          # magnitud of vector rr1
       B1 =  q1*cross(v1,rr1)/(4*pi *rr**3) # B field at q2
       B2 =  q2*cross(v2,rr2)/(4*pi *rr**3) # B field at q1
       E1 = q1*rr1/(4*pi*rr**3) # E field of q1 at  q2
       E2 = q2*rr2/(4*pi*rr**3) # E field of q2 at q1
       ...
       r1 = r1+v2*dt
       x2 = r1.x                 # x component of r (x2) after dt
       dx = x2-x1
