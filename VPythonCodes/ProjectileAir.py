...
# ProjectileAir.py: VPython, O(dt^2) projectile + drag
...
graph1 = graph(title='Projectile +- Drag', xtitle='x',
	ytitle='y', xmax=R, xmin=-R/20., ymax=8, ymin=-6.0)
