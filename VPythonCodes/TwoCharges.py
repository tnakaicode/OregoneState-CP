...
scene = canvas(width=700,height=300,range=1,background
	=vector(1,1,1), title= "In O: Initial Parallel Velocities")
...
scene2 = canvas(y=700,width=700,height=300, range=1, 
	background=vector(1,1,1), title= "In O' (Moving Frame)")
r1p = r1;    r2p = r2
