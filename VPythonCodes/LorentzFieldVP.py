...
# LorentzFieldVP.py:  Lorentz TF of E, B, & V with Visual

from vpython import *

scene = canvas(width=700,height=400,range=100,title="Dots: Bz in O")
...
def Euler():                  # Euler method, solve Eq Mtn in O'
    ...
    den = (1-Vx*beta)      
    Vxp = (V.x-beta)/den; Vyp = Vy/den/gamma
    Vp = vector(Vxp,Vyp,0) 
    rp = r                                    # Initially aligned
