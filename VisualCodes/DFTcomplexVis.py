...
Ycomplex = np.zeros(N, complex)       # Arrays

SignalGraph = graph(x=0, y=0, width=600, height=250,
                    title='Signal y(t)', xtitle='x', ytitle='y(t)',
                    xmax=2. * np.pi, xmin=0, ymax=30, ymin=-30)
SignalCurve = gcurve(color=color.yellow)
TransformGraph = graph(x=0, y=250, width=600, height=250,
